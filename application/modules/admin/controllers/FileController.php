...
class Admin_FileController extends Zend_Controller_Action
{
	...
	{
		$this->view->file = $this->_getParam("curdir") . "/" . $this->_getParam("image");
		$path = pathinfo($_SERVER["PHP_SELF"]);
		$this->view->file = realpath($_SERVER["DOCUMENT_ROOT"] . "/" . $path["dirname"] . "/uploads/" . $this->view->file) . $this->_getParam("image");
//		if(is_file($file))
	}
