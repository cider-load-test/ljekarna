...
class Admin_PageController extends Zend_Controller_Action
{
	...
	function init()
	{
		...
		if (isset($session->pageCategory))
	    	$this->currentCategory = $session->pageCategory;
		else
		{
		    $session->pageCategory = "Prospekta";
		    $this->currentCategory = $session->pageCategory;		    
		}
	...
	public function indexAction()
	{
		...
		$this->view->category = $this->currentCategory;
		$pages = new Pages();		
		$this->view->tree = $pages->getTree($this->currentCategory);	
	}
	
	public function categoryAction()
	{
		$category = $this->_getParam('name', 'Prospekta');
		$session = new Zend_Session_Namespace('Default');
		$session->pageCategory = $category;
	...
	public function newAction()
	{
		...
		$this->view->page->category = $this->currentCategory;
		$this->view->page->slug = "";
		$this->view->page->text = "";
		...
		$pages = new Pages();
		$this->view->paths = $pages->getAllPaths($this->currentCategory);		
		$files = new Files();
